...
public class ModbusUtil {
    ...
    public static void batchRead() throws ModbusTransportException, ErrorResponseException, ModbusInitException {
        ...
        batch.addLocator(0, BaseLocator.holdingRegister(1, 40000, DataType.TWO_BYTE_INT_SIGNED));
        batch.addLocator(1, BaseLocator.holdingRegister(1, 40001, DataType.TWO_BYTE_INT_SIGNED));
