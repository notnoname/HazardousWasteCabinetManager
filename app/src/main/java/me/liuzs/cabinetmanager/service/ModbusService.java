...
public class ModbusService {
    ...
    public synchronized static AirConditionerStatus readAirConditionerStatus() {
        ...
        try {
            ...
            batch.addLocator(3, BaseLocator.holdingRegister(ModbusSlaveId, AirConditionerStatus.ACTargetTempAddress - 1, DataType.TWO_BYTE_INT_SIGNED));
            batch.addLocator(4, BaseLocator.holdingRegister(ModbusSlaveId, AirConditionerStatus.ACFanSpeedModelAddress - 1, DataType.TWO_BYTE_INT_SIGNED));
            batch.addLocator(5, BaseLocator.holdingRegister(ModbusSlaveId, AirConditionerStatus.ACFanSweepAddress - 1, DataType.TWO_BYTE_INT_SIGNED));
            batch.addLocator(6, BaseLocator.holdingRegister(ModbusSlaveId, AirConditionerStatus.ACRemoteWorkModelAddress - 1, DataType.TWO_BYTE_INT_SIGNED));
