...
public class StatusOption {
    public static final int UnionWorkModelAddress = 40703;
    ...
    public static final int AlertHumidityHighAddress = 2020;
    public static final int AlertTempLowAddress = 2021;
